...
final class BasalSegmentTests: XCTestCase {
    ...
    private let basalSegments: [BasalSegment] = [
        BasalSegment(index: 1, rate: 0.2, durationInMinutes: 120),
        BasalSegment(index: 2, rate: 0.4, durationInMinutes: 120),
        BasalSegment(index: 3, rate: 0.6, durationInMinutes: 120),
        BasalSegment(index: 4, rate: 0.8, durationInMinutes: 120),
        BasalSegment(index: 5, rate: 1.0, durationInMinutes: 120),
        BasalSegment(index: 6, rate: 1.2, durationInMinutes: 120),
        BasalSegment(index: 7, rate: 1.4, durationInMinutes: 120),
        BasalSegment(index: 8, rate: 1.6, durationInMinutes: 120),
        BasalSegment(index: 9, rate: 1.8, durationInMinutes: 120),
        BasalSegment(index: 10, rate: 2.0, durationInMinutes: 120),
        BasalSegment(index: 11, rate: 2.2, durationInMinutes: 120),
        BasalSegment(index: 12, rate: 2.4, durationInMinutes: 120),
    ]
    ...
    func testBetween() {
        ...
        XCTAssertEqual(60, basalSegmentsDeliveredBetween.first?.durationInMinutes)
        XCTAssertEqual(1.2, basalSegmentsDeliveredBetween.last?.rate)
        XCTAssertEqual(90, basalSegmentsDeliveredBetween.last?.durationInMinutes)
    }
}
