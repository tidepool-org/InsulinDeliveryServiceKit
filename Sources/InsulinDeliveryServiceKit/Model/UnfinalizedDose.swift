...
public struct UnfinalizedDose: RawRepresentable, Equatable, CustomStringConvertible, Hashable {
    ...
    init(bolusAmount: Double, startTime: Date, scheduledCertainty: ScheduledCertainty, isQuickBolus: Bool = false, automatic: Bool? = false, estimatedBolusDeliveryRate: Double) {
        self.doseType = .bolus
        ...
        self.isQuickBolus = isQuickBolus
    ...
    public var eventTitle: String {
        ...
        case .bolus:
            if isQuickBolus {
                return NSLocalizedString("Quick Bolus", comment: "Pump Event title for QuickBolus")
            } else {
    ...
    public init?(rawValue: RawValue) {
        ...
        self.isQuickBolus = rawValue[UnfinalizedDoseKey.isQuickBolus.rawValue] as? Bool ?? false
    ...
    public var rawValue: RawValue {
        var rawValue: RawValue = [
            ...
            UnfinalizedDoseKey.isQuickBolus.rawValue: isQuickBolus
        ]
