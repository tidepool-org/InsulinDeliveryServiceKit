...
open class InsulinDeliveryService: IDPumpComms {
    ...
    var acControlPoint: ACControlPoint
...
//            self.securityManager.setConstrainedCertificatePumpIdentifier(serialNumber: serialNumber, certificateNonce: certificateNonce)
    ...
    func reportErrorToPendingCompletion(_ error: DeviceCommError, forProcedureID procedureID: ProcedureID?, _ completion: Any?) {
    ...
    func reportSuccessToPendingCompletionForProcedureID(_ procedureID: ProcedureID?, _ completion: Any?) {
        guard let procedureID = procedureID,
              let completion = completion
        else { return }
